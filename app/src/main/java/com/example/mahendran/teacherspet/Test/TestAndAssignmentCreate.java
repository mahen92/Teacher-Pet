...
public class TestAndAssignmentCreate extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    TextView highScore;
    @BindView(R.id.lowestScore)
    TextView lowScore;
    @BindView(R.id.average)
    TextView average;
    @BindView(R.id.topranker)
    TextView topper;
            ...
            public void act(ArrayList<StudentValues> models) {
                ...
                for (StudentValues note : models) {
                    if (note.map.get(testName) != null) {
                        ...
                        sum = sum + value;
                        highScore.setText(getString(R.string.highest_mark) + highestValue);
                        lowScore.setText(getString(R.string.lowest_mark) + lowestvalue);
                        average.setText(getString(R.string.averager) + (sum / models.size()));
                        topper.setText(getString(R.string.topper) + toppStudent);
                    }
                }
            }
